...
let solved_train_names = (* 25 tasks, 301s for timeout=60s *)
...
let maybe_train_names =
  [
    ...
    "d5d6de2d.json"; (* TODO pb: fails to generalize from mapping first item to all items (use relax mechanism) *)
