...
let solved_train_names = (* 27 tasks, 27/26 success, 256s for timeout=60s, max_nb_parses=64 *)
  [ "08ed6ac7.json"; (* NEW 4 grey bars, colored in size order, runtime=27.5s *)
    ...
    "91714a58.json"; (* FAIL NEW find the main rectangle in a cloud of points, runtime=43.5. pb: succeeds on training examples but fails on test, not clear why exactly *)
